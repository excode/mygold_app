              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: MyText.bodyMedium("29, Jun 2020", fontWeight: 600),
                  ),
                  Container(
                  ...
                  Container(
                    ...
                    child: MyText.bodyMedium("26, Jun 2020", fontWeight: 600),
                  ),
                  Container(
                    padding: EdgeInsets.only(left: 12, right: 12, top: 12),
                    child: GridView.count(
                  ...
                  Container(
                    padding: EdgeInsets.only(top: 16, left: 16, right: 16),
                    child: MyText.bodyMedium("Older photos", fontWeight: 600),
                  ),
                  Container(
