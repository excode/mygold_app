    ...
    return SingleChildScrollView(
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            MyContainer.none(
              padding: MySpacing.fromLTRB(16, 8, 16, 20),
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            MyText.titleMedium("Love me",
                                color: theme.colorScheme.onBackground,
                                letterSpacing: 0.15,
                                fontWeight: 600),
                            MyText.bodyLarge("From older",
                                color: theme.colorScheme.onBackground
                                    .withAlpha(200),
                                letterSpacing: 0.10),
                          ],
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: MyText.titleSmall("Up Next",
                        color: theme.colorScheme.onBackground,
                        letterSpacing: 0.2,
                        fontWeight: 600),
                  ),
