...
class HiloDefault extends StatefulWidget {
  HiloDefault({Key? key}) : super(key: key);

  @override
  _HiloDefaultState createState() => _HiloDefaultState();
}

class _HiloDefaultState extends State<HiloDefault> {
  late TooltipBehavior _tooltipBehavior;

  @override
  Widget build(BuildContext context) {
    return Center(
      child: SizedBox(height: 320, child: _buildHilo()),
    );
  }
