...
class _SleepGaugeState extends State<SleepGauge> {
  ...
  void _handleWakeupTimeValueChanged(double value) {
    setState(() {
      ...
      final int value0 = _wakeupTimeValue.abs().toInt();
      final int hourValue0 = value0;
      ...
      final double hour = (hourValue0 >= 0 && hourValue0 <= 6)
          ? (hourValue0 + 6)
          : (hourValue0 >= 6 && hourValue0 <= 12)
              ? hourValue0 - 6
              : 0;
      ...
      _sleepHours = sleepDuration.toString().split(':')[0];
      _sleepMinutes = sleepDuration.toString().split(':')[1];
    });
  }
  ...
  void _handleBedTimeValueChanged(double value) {
    setState(() {
      _bedTimeValue = value;
      final int value0 = _bedTimeValue.abs().toInt();
      final int hourValue = value0;
