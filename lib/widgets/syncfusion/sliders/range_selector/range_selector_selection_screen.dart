...
class RangeSelectorSelectionScreen extends StatefulWidget {
  @override
  _RangeSelectorSelectionScreenState createState() =>
      _RangeSelectorSelectionScreenState();
}

class _RangeSelectorSelectionScreenState
    extends State<RangeSelectorSelectionScreen> {
  ...
  void _setTotalDataUsage(SfRangeValues values) {
    ...
    for (int i = 0; i < data.length; i++) {
      if (data[i].date.isAfter(
              (values.start as DateTime).subtract(Duration(hours: 1))) &&
          data[i].date.isBefore(
              //ignore: avoid_as
              (values.end as DateTime).add(Duration(hours: 1)))) {
              ...
              child: Center(
                child: SfRangeSelectorTheme(
                  data: SfRangeSelectorThemeData(
                      ...
                      overlayColor: Color.fromRGBO(0, 178, 206, 0.24),
                      activeTrackColor: Color.fromRGBO(0, 178, 206, 1),
                      thumbStrokeColor: Color.fromRGBO(0, 178, 206, 1),
                      thumbStrokeWidth: 2.0,
                      inactiveTrackColor: Color.fromRGBO(194, 194, 194, 1),
                          ...
                          series: <CartesianSeries<_ChartData, DateTime>>[
                            ColumnSeries<_ChartData, DateTime>(
                              ...
                              selectionBehavior: SelectionBehavior(
                                  ...
                                  unselectedOpacity: 0,
                                  selectedBorderColor:
                                      Color.fromRGBO(0, 178, 206, 1),
                                  selectedColor: Color.fromRGBO(0, 178, 206, 1),
                                  unselectedColor: Colors.transparent,
                                  selectionController: rangeController),
                              dashArray: <double>[3, 2],
                              color: Color.fromRGBO(255, 255, 255, 0),
                              borderColor: Color.fromRGBO(194, 194, 194, 1),
                              animationDuration: 0,
                              borderWidth: 1,
                              dataSource: data,
