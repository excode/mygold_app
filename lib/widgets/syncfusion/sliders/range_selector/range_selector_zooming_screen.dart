...
import 'package:mygold/widgets/syncfusion/data/charts_sample_data.dart';
import 'package:syncfusion_flutter_charts/charts.dart';
import 'package:syncfusion_flutter_core/core.dart';
import 'package:syncfusion_flutter_core/theme.dart';
import 'package:syncfusion_flutter_sliders/sliders.dart';

class RangeSelectorZoomingScreen extends StatefulWidget {
  @override
  _RangeSelectorZoomingScreenState createState() =>
      _RangeSelectorZoomingScreenState();
}

class _RangeSelectorZoomingScreenState
    extends State<RangeSelectorZoomingScreen> {
    ...
    columnChart = SfCartesianChart(
      ...
      series: <SplineAreaSeries<ChartSampleData, DateTime>>[
        SplineAreaSeries<ChartSampleData, DateTime>(
          ...
          borderColor: Color.fromRGBO(0, 193, 187, 1),
          color: Color.fromRGBO(163, 226, 224, 1),
    ...
    splineChart = SfCartesianChart(
      ...
      series: <SplineSeries<ChartSampleData, DateTime>>[
        SplineSeries<ChartSampleData, DateTime>(
          name: 'EUR',
          dataSource: splineSeriesData,
          color: Color.fromRGBO(0, 193, 187, 1),
          animationDuration: 0,
          xValueMapper: (ChartSampleData sales, _) => sales.x as DateTime,
          yValueMapper: (ChartSampleData sales, _) => sales.y,
        ),
            ...
            children: <Widget>[
              Expanded(
                child: Container(
                    ...
                    padding: EdgeInsets.fromLTRB(5, 20, 15, 25),
                    child: splineChart),
              ),
              SfRangeSelectorTheme(
                  data: SfRangeSelectorThemeData(
                      ...
                      activeTrackColor: Color.fromRGBO(255, 125, 30, 1),
                      inactiveRegionColor: isLightTheme
                          ? Colors.white.withOpacity(0.75)
                          : Color.fromRGBO(33, 33, 33, 0.75),
                      thumbColor: Colors.white,
                      thumbStrokeColor: Color.fromRGBO(255, 125, 30, 1),
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Padding(
                        padding: EdgeInsets.fromLTRB(14, 0, 15, 15),
