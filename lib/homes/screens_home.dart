...
import 'package:mygold/apps/auth/forgot_password2_screen.dart';
import 'package:mygold/apps/auth/login1_screen.dart';
import 'package:mygold/apps/auth/login2_screen.dart';
import 'package:mygold/apps/auth/login_register_screen.dart';
import 'package:mygold/apps/auth/otp_verification_screen.dart';
import 'package:mygold/apps/auth/register1_screen.dart';
import 'package:mygold/apps/auth/register2_screen.dart';
import 'package:mygold/apps/chat/chat_facebook_page.dart';
import 'package:mygold/apps/chat/chat_home_screen.dart';
import 'package:mygold/apps/chat/chat_whatsapp_page.dart';
import 'package:mygold/apps/course/course_full_app.dart';
import 'package:mygold/apps/dashboard/lms_dashboard_screen.dart';
import 'package:mygold/apps/dashboard/seller_dashboard_screen.dart';
import 'package:mygold/apps/event/event_full_app.dart';
import 'package:mygold/apps/food/food_on_boarding_screen.dart';
import 'package:mygold/apps/handyman/handyman_full_app.dart';
import 'package:mygold/apps/health/health_full_app.dart';
import 'package:mygold/apps/hotel/hotel_login_screen.dart';
import 'package:mygold/apps/hotel/hotel_onboarding_screen.dart';
import 'package:mygold/apps/hotel/hotel_password_screen.dart';
import 'package:mygold/apps/hotel/hotel_profile_screen.dart';
import 'package:mygold/apps/hotel/hotel_register_screen.dart';
import 'package:mygold/apps/mail/mail_home_screen.dart';
import 'package:mygold/apps/music/music_login_screen.dart';
import 'package:mygold/apps/music/music_onboarding_screen.dart';
import 'package:mygold/apps/music/music_password_screen.dart';
import 'package:mygold/apps/music/music_register_screen.dart';
import 'package:mygold/apps/news/news_categery_screen.dart';
import 'package:mygold/apps/other/about_app_screen.dart';
import 'package:mygold/apps/other/empty_cart_screen.dart';
import 'package:mygold/apps/other/faq_question_screen.dart';
import 'package:mygold/apps/other/maintenance_screen.dart';
import 'package:mygold/apps/other/no_internet_screen.dart';
import 'package:mygold/apps/other/page_not_found_screen.dart';
import 'package:mygold/apps/other/product_sold_out_screen.dart';
import 'package:mygold/apps/other/terms_screen.dart';
import 'package:mygold/apps/profile/company_profile_screen.dart';
import 'package:mygold/apps/profile/edit_profile_screen.dart';
import 'package:mygold/apps/profile/profile_screen.dart';
import 'package:mygold/apps/quiz/quiz_customize_screen.dart';
import 'package:mygold/apps/quiz/quiz_question_type1_screen.dart';
import 'package:mygold/apps/quiz/quiz_question_type2_screen.dart';
import 'package:mygold/apps/setting/account_setting_screen.dart';
import 'package:mygold/apps/setting/basic_setting_screen.dart';
import 'package:mygold/apps/setting/notification_setting_screen.dart';
import 'package:mygold/apps/setting/privacy_security_setting_screen.dart';
import 'package:mygold/apps/shopping/shopping_login_screen.dart';
import 'package:mygold/apps/shopping/shopping_onboarding_screen.dart';
import 'package:mygold/apps/shopping/shopping_password_screen.dart';
import 'package:mygold/apps/shopping/shopping_profile_screen.dart';
import 'package:mygold/apps/shopping/shopping_register_screen.dart';
import 'package:mygold/apps/social/social_full_app.dart';
import 'package:mygold/apps/wallet/wallet_crypto_screen.dart';
import 'package:mygold/apps/wallet/wallet_home_screen.dart';
import 'package:mygold/apps/wallet/wallet_payment_screen.dart';
...
import 'package:mygold/homes/single_grid_item.dart';
