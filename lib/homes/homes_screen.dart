...
import 'package:mygold/homes/animations_home.dart';
import 'package:mygold/homes/app_setting_screen.dart';
import 'package:mygold/homes/full_apps_home.dart';
import 'package:mygold/homes/material_widgets_home.dart';
import 'package:mygold/homes/others_home.dart';
import 'package:mygold/homes/screens_home.dart';
import 'package:mygold/homes/select_language_dialog.dart';
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                InkWell(
                  onTap: () {
                    memberController.alertLog(context);
                  },
                  child: Container(
                    padding: MySpacing.x(20),
                    child: Image(
                      image: AssetImage(Images.loginIcon),
                      color: theme.colorScheme.onSurface,
                      width: 24,
                      height: 24,
                    ),
            ...
            bottomNavigationBar: FlashyTabBar(
              ...
              items: [
                ...
                FlashyTabBarItem(
                  icon: const Icon(LucideIcons.boxes),
                  title: const Text(
                    'Widgets',
                  ),
                  activeColor: theme.colorScheme.primary,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  MyContainer(
                    ...
                    child: MyText.bodyLarge("v1.0.1",
                        color: theme.colorScheme.primary,
                        fontWeight: 700,
                        letterSpacing: 0.2),
                  ),
                  MySpacing.height(16),
                  MyText.bodyMedium("MyGold",
