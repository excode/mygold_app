...
import 'package:mygold/helpers/theme/custom_theme.dart';
import 'package:mygold/helpers/theme/theme_type.dart';
...
//---------------------------NEW-----------------------------------------
  ...
  static ThemeData myGoldTheme = ThemeData(
    colorScheme: ColorScheme.fromSeed(
      seedColor: const Color(0xffD4AF37), // Metallic gold seed color
      primary: const Color(0xff005247), // Metallic gold
      onPrimary: const Color(0xffFFEACE), // Black for contrast
      primaryContainer: const Color(0xffFFD700), // Gold container
      onPrimaryContainer: const Color(0xff000000), // Black for contrast
      secondary: const Color(0xff4B8077), // Dark goldenrod
      onSecondary: const Color(0xffF2FEDC), // White for contrast
      secondaryContainer: const Color(0xffDAA520), // Goldenrod container
      onSecondaryContainer: const Color(0xff000000), // Black for contrast
      surface: const Color(0xfff0e68c), // Khaki surface for metallic feel
      onSurface: const Color(0xff005247), // Black for text on surfaces
    ),
    textTheme: const TextTheme(
      bodyLarge: TextStyle(color: Color(0xff000000)), // Black text for body
      bodyMedium: TextStyle(color: Color(0xff000000)), // Black text for body
      headlineLarge:
          TextStyle(color: Color(0xff000000)), // Black text for headlines
      headlineMedium:
          TextStyle(color: Color(0xff000000)), // Black text for headlines
    ),
    appBarTheme: const AppBarTheme(
      backgroundColor: Color(0xff9B714B), // Metallic gold app bar
      titleTextStyle: TextStyle(
          color: Color(0xff000000), fontSize: 20, fontWeight: FontWeight.bold),
    ),
    buttonTheme: const ButtonThemeData(
      buttonColor: Color(0xff005247), // Metallic gold buttons
      textTheme: ButtonTextTheme.primary,
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor:
            const Color(0xff005247), // Metallic gold elevated button
        foregroundColor: const Color(0xff000000), // Black text
      ),
    ),
    floatingActionButtonTheme: const FloatingActionButtonThemeData(
      backgroundColor: Color(0xff005247), // Metallic gold FAB
    ),
    cardTheme: const CardTheme(
      color: Color(0xffFFF8DC), // Cornsilk card background
      shadowColor: Color(0xff005247), // Metallic gold shadow
    ),
    inputDecorationTheme: const InputDecorationTheme(
      filled: true,
      fillColor: Color(0xffFFF8DC), // Cornsilk input background
      border: OutlineInputBorder(
        borderSide:
            BorderSide(color: Color(0xffD4AF37)), // Metallic gold border
      ),
      focusedBorder: OutlineInputBorder(
        borderSide: BorderSide(
            color: Color(0xffD4AF37)), // Metallic gold focused border
      ),
      labelStyle: TextStyle(color: Color(0xff000000)), // Black text for labels
    ),
  );
...
*/
  ...
  static ThemeData getNFTTheme() {
    ...
    // return createTheme(ColorScheme.fromSeed(seedColor: const Color(0xff232245)));
  }
