...
import 'package:mygold/apps/mygold/models/user.dart';
import 'package:mygold/full_apps/other/cookify/models/recipe.dart';
import 'package:mygold/full_apps/other/cookify/views/recipe_screen.dart';
...
class _CookifyHomeScreenState extends State<CookifyHomeScreen> {
  ...
  void loadInfo() async {
    ...
    String token = await localStore.read(Config.token);
    User user_ = User.getOne(token);
    //
    setState(() {
      user = user_;
    });
