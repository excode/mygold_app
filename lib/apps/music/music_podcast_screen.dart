...
class _MusicPodcastScreenState extends State<MusicPodcastScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Center(
          child: MyText.titleMedium("Podcast",
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              MyText.titleMedium("Recent Shows",
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              MyText.titleMedium("Popular Shows",
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
              ...
              child:
                  MyText.bodyMedium(text, letterSpacing: 0.2, fontWeight: 500))
        ],
      ),
    );
  }
