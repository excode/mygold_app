...
class _MusicPlayListScreenState extends State<MusicPlayListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Center(
          child: MyText.titleMedium("Playlist",
        ...
        Container(
            ...
            child: MyText.bodyLarge("All Tracks", fontWeight: 600)),
        Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child:
                MyText.bodyMedium(title, fontWeight: 600, letterSpacing: 0.2),
          )
        ],
      ),
    );
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                MyText.titleSmall(name, fontWeight: 600, letterSpacing: 0.2),
                MyText.bodyMedium(album,
                    color: theme.colorScheme.onBackground, letterSpacing: 0.10)
              ],
            ),
          ),
          MyText.bodyLarge(duration, fontWeight: 600, letterSpacing: 0.2),
        ],
      ),
    );
  }
