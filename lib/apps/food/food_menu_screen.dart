...
import 'package:mygold/apps/food/food_product_screen.dart';
import 'package:mygold/helpers/theme/app_theme.dart';
import 'package:mygold/helpers/widgets/my_star_rating.dart';
...
class _FoodMenuScreenState extends State<FoodMenuScreen> {
  ...
  final List<bool> _dataExpansionPanel = [false, false, true, false, false];
                ...
                ExpansionPanelList(
                  ...
                  children: <ExpansionPanel>[
                    ...
                    ExpansionPanel(
                        ...
                        headerBuilder: (BuildContext context, bool isExpanded) {
                          return ListTile(
                            title: MyText.titleSmall("Burger",
                                color: isExpanded
                                    ? theme.colorScheme.primary
                                    : theme.colorScheme.onBackground,
                                fontWeight: isExpanded ? 700 : 600),
                    ...
                    ExpansionPanel(
                        ...
                        headerBuilder: (BuildContext context, bool isExpanded) {
                          return ListTile(
                            title: MyText.titleSmall("Beverage",
                                color: isExpanded
                                    ? theme.colorScheme.primary
                                    : theme.colorScheme.onBackground,
                                fontWeight: isExpanded ? 700 : 600),
                    ...
                    ExpansionPanel(
                        ...
                        headerBuilder: (BuildContext context, bool isExpanded) {
                          return ListTile(
                            title: MyText.bodyLarge("Dessert",
                                color: isExpanded
                                    ? theme.colorScheme.primary
                                    : theme.colorScheme.onBackground,
                                fontWeight: isExpanded ? 700 : 600),
