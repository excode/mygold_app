...
import 'package:mygold/apps/food/food_restaurant_screen.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              child: MyText.bodySmall(place, fontWeight: 400)),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            margin: EdgeInsets.only(left: 8),
                            child: MyText.bodySmall(rateCount.toString()),
                          )
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: MyText.bodySmall("View menu",
                          fontWeight: 500,
